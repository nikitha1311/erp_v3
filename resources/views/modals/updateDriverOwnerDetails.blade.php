@component('layouts.modal')
    ...
    <form action="{{ "/loading-hire-agreements/".$lha->id."/driver-owner-details" }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="owner_name" name="owner_name"
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="owner_phone" name="owner_phone"
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="driver_name" name="driver_name"
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" id="driver_phone" name="driver_phone"
